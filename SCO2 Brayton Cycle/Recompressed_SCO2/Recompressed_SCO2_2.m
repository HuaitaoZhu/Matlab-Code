...
%% HEX
recu=0.3509;
co2(10,1)=co2(6,1)+recu*(co2(5,1)-co2(6,1));
[co2(10,3),co2(10,4),co2(10,5)]=refpropm('HSD','T',co2(10,1),'P',co2(10,2),'CO2');

co2(7,3)=(co2(10,3)-co2(6,3)+co2(2,3)*rs)/rs;
[co2(7,1),co2(7,4),co2(7,5)]=refpropm('TSD','P',co2(7,2),'H',co2(7,3),'CO2');

co2(9,3)=co2(8,3)-co2(6,3)+co2(10,3)+rs*(co2(2,3)-co2(8,3));
[co2(9,1),co2(9,4),co2(9,5)]=refpropm('TSD','P',co2(9,2),'H',co2(9,3),'CO2');
